...
module.exports = function (RED) {
    function FunctionNode(n) {
        ...
        this.on('input', function (msg) {
            ...
            if(!node.url){
                node.url = 'https://openapi.naver.com/v1/search/encyc.json';
            }
    ...
    RED.nodes.registerType("naverencyclopedia", FunctionNode, {
        credentials: {
            clientId: {type:"text"},
    ...
    function naverencyclopediaApiKey(n){
        RED.nodes.createNode(this, n);
        this.clientId = n.clientId;
        this.clientSecret = n.clientSecret;
    }

    RED.nodes.registerType("naverencyclopediaApiKey", naverencyclopediaApiKey,{
        credentials: {
            clientId: {type:"text"},
            clientSecret: {type:"text"}
        }
